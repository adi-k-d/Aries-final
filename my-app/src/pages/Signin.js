    ...
    login(email, password)
      .then(async (res) => {
        try {
          ...
          await setDoc(userRef, { isOnline: true })
          navigate("/")
        } catch (e) {
    ...
    signInWithGoogle()
      .then(async (res) => {
        ...
        try {
          ...
          console.log("Document written with ID: ", docRef.id, currentUser)
          navigate("/")
        } catch (e) {
          console.error("Error adding document: ", e)
        }
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center mb-6 -mt-4">
              <div className="flex ml-auto">
                <div className="inline-flex text-xs font-thin text-gray-500 sm:text-sm dark:text-gray-100 hover:text-gray-700 dark:hover:text-white">
